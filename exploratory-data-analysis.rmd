...
```{r income-vs-crimes, fig.width=10, fig.height=6, cache=TRUE}
df_merge |>
    group_by(sa2_name) |>
    summarize(
...
```{r telecom-vs-crimes, fig.width=10, fig.height=6, cache=TRUE}
df_merge |>
    group_by(sa2_name) |>
    summarize(
...
```{r crowding-vs-crimes, fig.width=10, fig.height=6, cache=TRUE}
df_merge |>
    group_by(sa2_name) |>
    summarize(
        `Crowded (%)` =
...
```{r landlord-vs-crimes, fig.width=10, fig.height=6, cache=TRUE}
df_merge |>
    group_by(sa2_name) |>
    summarize(
...
```{r rental-vs-crimes, fig.width=10, fig.height=6, cache=TRUE}
df_merge |>
    group_by(sa2_name) |>
    summarize(
